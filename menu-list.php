                                    ...
                                    foreach($menus as $menu){
                                        ...
                                        <div class="food__list__thumb">
                                            <a href="menu-details.html">
                                                <img src="images/menu_images/'.$menu->food_img.'" alt="list food images">
                                            </a>
                                        </div>
                                        <div class="food__list__inner d-flex align-items-center justify-content-between">
                                            <div class="food__list__details mt-2">
                                                <h2><a href="menu-details.php?id='.$menu->id.'">'.$menu->menu_name.'</a></h2>
                                                <p>'.$menu->description.'</p>
                                                <div class="list__btn">
                                                    <a class="food__btn grey--btn theme--hover" href="menu-details.php?id='.$menu->id.'">Order Now</a>
                                                </div>
                                            </div>
